...
Provides a realistic config and mock API responses.
"""
...
def base_config():
    return {
        ...
        "fees": {
            "base_fee_msat": 1000,
            "base_fee_rate_ppm": 100,
            "congestion_fee_bump_ppm": 50,
